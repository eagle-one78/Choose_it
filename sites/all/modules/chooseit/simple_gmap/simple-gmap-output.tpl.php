...
if ($include_map) : ?>
  <iframe
    ...
    marginheight="0"
    marginwidth="0"
    src="http://maps.google.com/maps?hl=<?php print $langcode; ?>&amp;q=<?php print $url_suffix; ?>&amp;iwloc=<?php print ($information_bubble ? 'A': ''); ?>&amp;z=<?php print $zoom; ?>&amp;t=<?php print $map_type; ?>&amp;output=embed">
  </iframe>
<?php endif; ?>
<?php if ($include_link) : ?>
<p class="simple-gmap-link">
  <a href="http://maps.google.com/maps?q=<?php print $url_suffix; ?>&amp;hl=<?php print $langcode; ?>&amp;iwloc=<?php print ($information_bubble ? 'A': ''); ?>&amp;z=<?php print $zoom; ?>&amp;t=<?php print $map_type; ?>" target="_blank"><?php print $link_text; ?>
  </a>
</p>
<?php endif; ?>
<?php if (!empty($address_text)) : ?>
<p class="simple-gmap-address">
  <?php print $address_text; ?>
</p>
<?php endif; ?>
